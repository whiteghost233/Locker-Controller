    ...
    <div>
        <div class="crumbs">
            <el-breadcrumb separator="/">
                <el-breadcrumb-item>
                    <i class="el-icon-lx-cascades"></i> 快储储物柜
                </el-breadcrumb-item>
            </el-breadcrumb>
        </div>
        <div class="container">
            <div class="handle-box">
                ...
                <el-input v-model="query.name" placeholder="储物柜名称" class="handle-input mr10"></el-input>
            ...
            >
                ...
                <el-table-column prop="remainSize" label="已使用">
                    <template slot-scope="scope">
                        <el-progress type="circle" :percentage="(scope.row.currSize*100/(scope.row.currSize+scope.row.remainSize)).toFixed(2)" color="#57DCDD" :text-inside="false" :stroke-width="12" />
                    </template>
                </el-table-column>
...
export default {
    ...
    methods: {
        ...
        handleSearch() {
            ...
            console.log("cxk"+this.tableData.length+this.tableData)
