    ...
    <div>
        ...
        <div class="container">
            <div class="handle-box">
                ...
                <el-input v-model="keyword" placeholder="设备名" class="handle-input mr10"></el-input>
                <el-button type="primary" icon="el-icon-search" @click="handleSearch">搜索</el-button>
                ...
                <el-button type="primary"  class="handle-refresh" icon="el-icon-lx-add" @click="handleAdd">添加设备</el-button>
                <el-button type="success" class="handle-refresh"  @click="handleRefresh">刷新</el-button>
            </div>
            <el-table
                :data="tableData"
                border
        ...
        handleSearch() {   
            ...
            if(this.keyword){
                for (let i = 0; i < this.tableData.length; i++) {
                    if(this.tableData[i].name.search(this.keyword)!=-1){
                        curData.push(this.tableData[i])
                    }
                }
